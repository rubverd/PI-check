...
def register_local_apk(
    ...
    try:
        ...
        if request.run_mobsf:
            logger.info(
                "[MOBSF] Registro local solicita análisis para app_id=%s version=%s",
        ...
        app_item = RegisteredAppItem(
            ...
            category=prepared.application.categoria
            or prepared.app_version.categoria
            or "",
