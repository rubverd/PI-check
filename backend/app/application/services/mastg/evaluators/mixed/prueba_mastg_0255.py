...
def evaluate(context: MastgEvaluationContext) -> MastgRuleResult:
    return MastgRuleResult(
        ...
        summary="Minimización de privilegios: evaluador pendiente de implementar.",
        details={
            "id_mastg": "MASTG-TEST-0255",
            "reason": "Evaluador mixto pendiente de implementar para minimización de privilegios.",
